...
var productAdmin = function() {
    ...
    for (var i in product){
        ...
        var listProduct1 = '<tr>'
            ...
            listProduct1 +='<td><button onclick="updateProduct('+i+')" class="btn btn-outline-warning" data-toggle="modal" data-target="#updateProduct"><i class="fas fa-cogs"></i></button></td>'
            listProduct1 +='<td><button onclick="deleteProduct('+i+')" class="btn btn-outline-danger ml-1"><i class="fas fa-trash"></i></button></td>'
            listProduct1 +='</tr>'
